...
public class URIRunner {
    public static void main(String[] args) throws URISyntaxException, IOException {
        ...
        urlConnection.addRequestProperty("User-Agent", "Mozilla/5.0(Windows NT 10.0; Win64; x64) AppleWebKit/537.36(KHTML, like Gecko) Chrome/97.0.462.71 safary/537.36");
        ...
        System.out.println("Адреса ресурса: " + resource);
